      ...
      <div class="py-12 md:pt-32 md:pb-20">
        ...
        <div class="pb-12 md:pb-14">
          <div class="relative text-center md:text-left">
            ...
            <h2 class="h2 font-cabinet-grotesk">Some of my works</h2>
          </div>
        </div>
        ...
        <div>
          <div class="grid lg:grid-cols-2 gap-8">
            <div class="cursor-pointer">
              <router-link to="/unilin"
                ><div
                  class="bg-white rounded-3xl shadow-lg p-4 border border-slate-100 group h-[100%]"
                >
                  <div class="relative w-full">
                    <img
                      ...
                      src="../images/project-unilin.webp"
                    />
                  </div>
                  <div>
                    <h1 class="py-4 text-xl font-semibold">
                      Unilin Replatforming
                    </h1>
                    <div class="flex space-x-2 justify-between items-center">
                      ...
                      <div
                        class="flex items-center space-x-2 lg:space-x-4 text-slate-600"
                      >
                        <p
                          class="text-sm opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0 whitespace-nowrap"
                        >
                          Read More
                        </p>
                        <svg
                          ...
                          class="svg-inline--fa fa-arrow-right w-8 h-8 p-2 border border-slate-200 rounded-full -rotate-45 group-hover:rotate-0 transition"
                          role="img"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 448 512"
                        >
                ...
                >
                  <div class="relative w-full">
                    <img
                      ...
                      class="rounded-2xl shadow-lg w-full object-cover"
                      style="color: transparent"
                      src="../images/project-appartments.webp"
                    />
                  </div>
                  <div>
                    <h1 class="py-4 text-xl font-semibold">
                ...
                >
                  <div class="relative w-full">
                    <img
                      ...
                      class="rounded-2xl shadow-lg w-full object-cover"
                      style="color: transparent"
                      src="../images/project-pizza.webp"
                    />
                  </div>
                  <div>
                    <h1 class="py-4 text-xl font-semibold">Pizza Project</h1>
                    <div class="flex space-x-2 justify-between items-center">
                      <div class="flex gap-2 flex-wrap">
                        <div
                          class="inline-flex items-center border rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground whitespace-nowrap"
