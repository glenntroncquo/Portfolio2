<template>
  <section class="relative overflow-hidden">
    <!-- Bg -->
    <div
      class="absolute inset-0 rounded-bl-[100px] bg-gray-50 pointer-events-none -z-10"
      aria-hidden="true"
    ></div>

    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-12 lg:pt-40 lg:pb-20">
        <!-- Hero content -->
        <div
          class="max-w-xl mx-auto lg:max-w-none text-center lg:text-left flex flex-col lg:flex-row"
        >
          <!-- Content -->
          <div class="lg:w-[640px]">
            <!-- Copy -->
            <h1
              class="h1 font-cabinet-grotesk mb-10 sm:mb-6"
              data-aos="fade-right"
              data-aos-delay="100"
              id="header"
            >
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Hi! My name is Glenn, a Full Stack Web Developer with a passion
              for building functional web and mobile applications. Join me on a
              journey of self-learning and helping of others building web
              applications!
            </p>
            <!-- Buttons -->
            <div
              class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12 lg:mb-20"
              data-aos="fade-right"
              data-aos-delay="300"
            >
              <div>
                <a
                  class="btn text-white bg-blue-500 hover:bg-blue-600 w-full shadow-sm"
                  href="mailto:glenntroncquo@hotmail.com"
                  >Contact me</a
                >
              </div>
              <div>
                <a
                  class="btn text-gray-600 bg-white hover:bg-blue-100 hover:text-blue-600 w-full shadow-sm"
                  target="_blank"
                  href="https://www.linkedin.com/in/glenn-troncquo/"
                >
                  <svg
                    fill="#1F2937"
                    width="24px"
            ...
            <div data-aos="fade-right" data-aos-delay="400">
              <div class="relative text-center lg:text-left mb-4">
                <svg
                  class="fill-gray-300 hidden lg:block absolute -ml-7 -mt-8"
                  width="22"
                  height="30"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <h2 class="h3 font-cabinet-grotesk">My favorite stack</h2>
              </div>
              <div class="inline-flex items-center space-x-4 lg:space-x-6">
                <div>
                  <div class="font-cabinet-grotesk text-2xl font-extrabold">
                    .NET
                  </div>
          ...
          <!-- Image -->
          <div
            class="max-w-sm mx-auto lg:max-w-none lg:absolute lg:top-[-100px] lg:right-[-240px] xl:top-[-20px] xl:right-[-60px]"
            data-aos="fade-left"
            data-aos-duration="1100"
          >
            <img
              src="../images/hero-glenn.webp"
              class="mt-16 lg:mt-0 md:block lg:max-w-none lg:w-[600px]"
              width="500"
              height="580"
              alt="Intro picture of myself"
            />
          </div>
        </div>
      </div>
  ...
  <!-- <img
    src="../images/hero-glenn-small.webp"
    class="md:hidden lg:max-w-none w-[200px] mt-7 mx-auto"
    width="500"
    height="580"
    alt="Intro picture of myself"
  /> -->
