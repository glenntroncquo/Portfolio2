    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pb-8">
        <div class="relative">
          <!-- Gray box -->
          <div
            class="absolute inset-0 bg-gray-100 rotate-2 -z-10"
            aria-hidden="true"
          ></div>
          ...
          <div class="relative px-6 pb-8 md:px-12 lg:pb-0">
            ...
            <div class="testimonial-carousel swiper-container">
              <div class="swiper-wrapper">
                <!-- Testimonial -->
                <div
                  class="cursor-pointer swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left"
                >
                  <div class="shrink-0 relative inline-flex">
                    <img
                      class="rounded-full"
                      src="../images/romy.webp"
                      width="280"
                      height="280"
                      alt="Testimonial 01"
                    />
                    <div class="absolute right-0 bottom-0 mr-4 mb-6">
                      <a
                        class="flex items-center font-cabinet-grotesk font-bold decoration-blue-500 decoration-2 underline-offset-2 hover:underline px-3 py-1 bg-white rounded-full shadow-sm"
                        href="https://www.linkedin.com/in/romuald-flouw-23bb84193/"
                        target="_blank"
                      >
                        <svg
                          fill="#1F2937"
                        ...
                        <span>@RomualdFlouw</span>
                      </a>
                    </div>
                  </div>
                  <div class="relative">
                    <svg
                      class="absolute left-0 top-0 -mt-16"
                      width="24"
                      height="48"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    <h4 class="h3 font-cabinet-grotesk mb-4">
                      It's a pleasure to work together with Glenn, whose
                      collaborative, problem-solving, and committed to quality
                      code.
                    </h4>
                    <!-- <div>
            ...
            <!-- Bullets -->
            <div
              class="mt-4 lg:absolute bottom-0 right-0 lg:mt-0 lg:mr-12 lg:mb-16 z-10"
            >
