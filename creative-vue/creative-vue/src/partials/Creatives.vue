    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 font-cabinet-grotesk">About me</h2>
        </div>

        <!-- Section content -->
        <div
          class="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-center space-y-8 md:space-y-0"
        >
          <!-- Creatives cards -->
          <div class="md:w-1/2" data-aos-id-cards>
            <div class="flex space-x-6">
              ...
              <div class="w-1/2 space-y-6">
                ...
                >
                  <img
                    class="w-full h-32 object-cover opacity-"
                    src="../images/glenn.webp"
                    width="258"
                    height="64"
                    alt="picture of me"
                  />
                  <div class="bg-white px-4 pb-6">
                    ...
                    <div class="mb-5">
                      <p
                        class="inline-block cursor-default font-cabinet-grotesk font-bold text-xl decoration-blue-500 decoration-2 underline-offset-2 hover:underline"
                      >
                        Programming 🧑‍💻
                      </p>
                ...
                >
                  <img
                    class="w-full h-48 object-cover opacity- mb-6"
                  ...
                  <div class="bg-white px-4 pb-6">
                    ...
                    <div>
                      <!-- <a
                        class="btn-sm text-white bg-gray-800 hover:bg-gray-900 shadow-sm"
                        href="#0"
                      >
                        <svg
                          class="mr-2"
              ...
              <div class="w-1/2 mt-6 space-y-6">
                ...
                >
                  <img
                    class="w-full h-32 object-cover opacity- mb-5"
                    src="../images/cycling.webp"
                    width="258"
                    height="64"
                    alt="Picture of me cycling"
                  />
                  <div class="bg-white px-4 pb-6">
                    <!-- <div class="relative inline-flex -mt-8 mb-3">
                      <img
                        class="inline-flex rounded-full"
                        src="../images/creative-03.webp"
                        width="64"
                        height="64"
                        alt="Creative 01"
                      />
          ...
          <div class="md:w-1/2 md:pl-10 lg:pl-20">
            <div class="text-center md:text-left">
              <!-- <img
                ...
                alt="Creatives"
              /> -->
              <h3 class="h3 font-cabinet-grotesk text-4xl mb-4">
                Some things I love doing
              </h3>
              <p class="text-xl text-gray-500 mb-6">
                In my freetime I love to take part in physical activities be it
                running, cycling, surfing, hiking,.. Anything where I can lose
                my energy I love doing. I also love traveling and exploring new
                parts of the world. And when I get bored developing helps me
                pass the time while keeping myself up to date with the latest
                trends!
              </p>
            </div>
          </div>
