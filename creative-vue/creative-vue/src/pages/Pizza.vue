    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 mb-6">
      ...
      <div class="pb-8">
        <div class="relative text-center lg:text-left mb-4">
          ...
          <h2 class="h3 font-cabinet-grotesk">Pizza Project</h2>
        </div>
      ...
      <div>
        <p>
          ePizza was a school project to test our front- backend and database
          practical skills. The result for me was a Pizza reservation platform
          with Firebase authentication. It is possible to order your pizza and
          for administrators it is possible to see all orders made as well as
          the stock from the different ingredients.
        </p>
      </div>
    </div>
    <Footer />
