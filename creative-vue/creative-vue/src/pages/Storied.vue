<template>
  <div className="flex flex-col min-h-screen overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 mb-6">
      <div class="rounded-3xl overflow-hidden h-96 mb-8">
        <img
          alt="RevSpy"
          loading="lazy"
          width="1200"
          ...
          data-nimg="1"
          class="object-cover"
          src="../images/project-storied.webp"
          style="color: transparent"
        />
      </div>
      <div class="pb-8">
        <div class="relative text-center lg:text-left mb-4">
          <svg
            class="fill-gray-300 hidden lg:block absolute -ml-7 -mt-4"
            width="22"
            height="30"
          ...
          <h2 class="h3 font-cabinet-grotesk">Storied Design Platform</h2>
        </div>
        <div class="flex gap-2 flex-wrap">
          <div
            class="inline-flex items-center border rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground whitespace-nowrap"
          >
            Angular
          </div>
          <div
      ...
      <div>
        <p>
          Storied is a small startup company in the United States that is
          building a platform for marketers and designers to build interactive
          web applications. You can think of it as Figma or AdobeXD but with the
          main difference that you can directly export your design to a
          functional web applicaiton. At storied I was responsible for creating
          a service to support the creation of interactive quizzes (e.g.,
          multiple choice) and polls, with real-time results. Aside from this
          task I was also responsible for implementing new features into the
          frontend platform.
        </p>
      </div>
    </div>
