    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 mb-6">
      ...
      <div class="pb-8">
        <div class="relative text-center lg:text-left mb-4">
          ...
          <h2 class="h3 font-cabinet-grotesk">Furnished Appartments</h2>
        </div>
      ...
      <div>
        <p>
          Furnished Appartments is a proof of concept web application that was
          presented to a potential client that was looking to renew his site.
          Unfortunately we didn't come to an agreement and it was left as a
          proof of concept. I still liked the design and development of this app
          so it deserved a place between my projects!
        </p>
      </div>
    </div>
    <Footer />
