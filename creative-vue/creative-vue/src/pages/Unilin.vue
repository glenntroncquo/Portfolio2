    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 mb-6">
      ...
      <div class="pb-8">
        <div class="relative text-center lg:text-left mb-4">
          ...
          <h2 class="h3 font-cabinet-grotesk">Unilin Replatforming</h2>
        </div>
      ...
      <div>
        <p>
          Unilin is a flooring company that is responsible for producing
          laminate, vinyl, mdf, . flooring and panels. Here we are replatforming
          or modernizing old shopfloor applications. So applications that are
          currently used on the floor within the factories of Unilin are being
          recreated with new technologies such as Angular and .NET 6 to replace
          the old Delphi applications.
        </p>
      </div>
    </div>
    <Footer />
